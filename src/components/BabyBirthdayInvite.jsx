...
export default function BabyBirthdayInvite() {
 ...
 // Сансрын фон (Одод анивчих эффект)
  ...
  <Rocket className="absolute -top-8 left-1/2 w-5 h-5 text-orange-400 animate-spin-slow" />
  <Moon className="absolute -bottom-1/4 -right-23 w-6 h-6 text-cyan-300 animate-twinkle" />
   <Star className="absolute -bottom-8 -left-16 w-6 h-6 text-red-400 animate-twinkle" />
  <Gift className="absolute -top-8 -right-32 w-6 h-6 text-green-300 animate-float-alt" />
  <Rocket className="absolute -bottom-9 left-20 w-5 h-5 text-blue-500 animate-float-alt" />
  <Moon className="absolute -bottom-1/4 -left-20 w-6 h-6 text-orange-300 animate-float-alt" />
