...
export default function BabyBirthdayInvite() {
 ...
 // Сансрын фон (Одод анивчих эффект)
  ...
  <Moon className="absolute -top-1/2 -right-25 w-6 h-6 text-cyan-300 animate-twinkle" />
  ...
  <Moon className="absolute -top-1/2 -left-20 w-6 h-6 text-orange-300 animate-float-alt" />
